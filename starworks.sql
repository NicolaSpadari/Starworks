...
--
-- Host: 127.0.0.1
-- Creato il: Nov 01, 2017 alle 11:18
...
(12, 'Is the Starworks accessible for disabled visitors?', 'We have worked very hard to make our venue fully accessible to all our guests. Click here for more information.');
...
(1, 'test1', 'Images/Albums/1.png', '2017-10-01'),
(2, 'test2', 'Images/Albums/2.png', '2017-10-01');
...
(1, 1, 'https://placehold.it/500x500&text=prova'),
(2, 1, 'https://placehold.it/500x500&text=prova'),
(3, 2, 'https://placehold.it/500x500&text=prova2'),
(4, 2, 'https://placehold.it/500x500&text=prova3');
