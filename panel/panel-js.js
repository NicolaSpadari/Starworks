...
$(document).on("click", ".clickable", function(){
    if($(this).parent().find('.overlay').hasClass('overlayed')){
        $(this).parent().find('.overlay').removeClass('overlayed');
    }else{
        $(this).parent().find('.overlay').addClass('overlayed');
    }
});*/

/* EDIT SLIDESHOW */
$(document).on("click", ".editSlide", function(e){
    var caption = $(this).parent().parent().children('.page-header').text();
    $(this).parent().parent().children('.page-header').replaceWith("<input class='edit-field capt' type='text' autofocus value='"+caption+"'/>");
    $(this).parent().children('.delete-slide').replaceWith("<button class='btn btn-warning cancel'>Cancel</button>");
